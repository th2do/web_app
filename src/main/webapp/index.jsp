	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To My Page!</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Hosted FTP</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">A Fully Managed FTP/SFTP Service. In the Cloud.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">	
A Fully Managed FTP/SFTP Service. In the Cloud.
Tired of managing in-house FTP and SFTP servers? Move to the Cloud! We can save you money, improve network security and give you better performance and features. 
24x7 Support with SLA. HIPAA BAA available.</p>
				</div>
			</div>
			<!-- About Section Button-->
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					href="https://hostedftp.com/signup"> <i
					class="fas fa-download me-2"></i> Free Sign Up!
				</a>
			</div>
		</div>
	</section>
						...
						<div class="d-none" id="submitSuccessMessage">
							<div class="text-center mb-3">
								...
								To activate this form, sign up at <br /> <a
									href="https://hostedftp.com/signup">https://hostedftp.com/signup</a>
							</div>
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						100-51 Breithaupt Street <br /> Kitchener, ON, Canada, N2H 5G5
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About HostedFTP</h4>
					<p class="lead mb-0">
						We are an ultra private boutique enterprise
						 software company doing a modern spin on an old classic
						  <a href="https://hostedftp.com/about">FTP</a> .
					</p>
				</div>
			</div>
		</div>
